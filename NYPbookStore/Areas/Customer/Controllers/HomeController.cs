...
using NYPBook.DataAccess.Repository.IRepository;
using NYPBook.Models;
using NYPbookStore.Models;
using NYPbookStore.Models.ViewModels;
using System;
...
namespace NYPbookStore.Ares.Customer.Controllers
{
    [Area("Customer")]
